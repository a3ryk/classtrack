...
class BatchAddSlotsScreen extends ConsumerStatefulWidget {
  const BatchAddSlotsScreen({super.key});

  @override
  ConsumerState<BatchAddSlotsScreen> createState() => _BatchAddSlotsScreenState();
}

class _BatchAddSlotsScreenState extends ConsumerState<BatchAddSlotsScreen> {
