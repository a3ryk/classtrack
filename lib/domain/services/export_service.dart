...
class ExportService {
  ...
  static Future<String> generateExcelReport({
    ...
    summarySheet.appendRow([TextCellValue('ATTENDLY ATTENDANCE REPORT')]);
          ...
          return pw.Column(
            ...
            children: [
              pw.Row(
                ...
                children: [
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text('ATTENDLY ATTENDANCE REPORT', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold)),
              ...
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text('Generated by Attendly App', style: const pw.TextStyle(fontSize: 8, color: PdfColors.grey600)),
          ...
          footer: (pw.Context context) {
            return pw.Container(
              ...
              child: pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text('Attendly Attendance Register', style: const pw.TextStyle(fontSize: 8, color: PdfColors.grey600)),
  ...
  static Future<String> exportJsonBackup({
    ...
    await NotificationService.instance.showExportCompleteNotification(
      ...
      body: 'Attendly JSON backup file is ready to share.',
    );
